# Swiss Ephemeris (Vendored Source)

This directory contains the vendored C source code for **Swiss Ephemeris**.

**Upstream source:** https://github.com/aloistr/swisseph

## License

This project uses Swiss Ephemeris under the copyleft license path (AGPL-style obligations),
consistent with our documented licensing decision.

Upstream license files and headers are preserved unmodified.

## Scope

- Upstream source only (vendored)
- No modifications are intended in this directory
- No build configuration lives here
- No Node bindings live here

## Usage boundary

This code may be compiled and accessed **only** via the Layer 0 native wrapper in `astro/native/`.
Direct usage elsewhere in the codebase is forbidden.
